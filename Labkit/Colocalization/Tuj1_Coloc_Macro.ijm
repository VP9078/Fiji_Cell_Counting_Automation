...
function processFile(input, filePath, output) {
	...
	stainls = newArray(stain_1,stain_2);
	...
	stain_3_img_path = output + File.separator + stain_3 + "_Auto_Cell_Area" + File.separator + stain_3 + "_Auto_Cell_Area_" + img_name;
	open(stain_3_img_path);
	rename("img3");
	run("RGB Color");
